 ...
 * @author ponki
 */
public class ReservationTransView extends javax.swing.JFrame {

    DefaultTableModel model = new DefaultTableModel();

    public ReservationTransView() {
        initComponents();
        setRecordsToTable();
    }
    ...
    private void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection.prepareStatement("SELECT * FROM ReservationTransaction;");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservationTransView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservationTransView().setVisible(true);
            }
        });
    }
