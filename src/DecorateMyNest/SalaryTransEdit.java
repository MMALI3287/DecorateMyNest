 ...
 * @author ponki
 */
public class SalaryTransEdit extends javax.swing.JFrame {

    /**
     * Creates new form ClientEdit
     */
    public SalaryTransEdit() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalaryTransEdit.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalaryTransEdit().setVisible(true);
            }
        });
    }
