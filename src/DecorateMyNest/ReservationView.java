...
public class ReservationView extends javax.swing.JFrame {
    ...
    private void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection.prepareStatement("SELECT * FROM Reservations;");
    ...
    private void clientsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientsbtnActionPerformed
        // TODO add your handling code here:
        ReservationView adminView = new ReservationView();
        adminView.show();
        dispose();
    ...
    private void AppointmentsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AppointmentsbtnActionPerformed
        // TODO add your handling code here:
        ReservationView appointmentsView = new ReservationView();
