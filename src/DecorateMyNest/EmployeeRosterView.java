 ...
 * @author ponki
 */
public class EmployeeRosterView extends javax.swing.JFrame {
    ...
    private void setRecordsToTable() {
        try {
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                int positionID = Welcome.jdbc.resultSet.getInt("PositionID");
                int adminID = Welcome.jdbc.resultSet.getInt("AdminID");

                model.addRow(new Object[]{employeeID, firstName, lastName, position, email, phone, positionID, adminID});
            }
    ...
    private void initComponents() {
        ...
        employeeRosterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EmployeeID", "FIrstName", "LastName", "Position", "Email", "Phone", "PositionID", "AdminID"
            }
        ) {
    ...
    private void clientsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientsbtnActionPerformed
        // TODO add your handling code here:
        EmployeeRosterView adminView = new EmployeeRosterView();
        adminView.show();
        dispose();
    ...
    private void AppointmentsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AppointmentsbtnActionPerformed
        // TODO add your handling code here:
        EmployeeRosterView appointmentsView = new EmployeeRosterView();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeRosterView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeRosterView().setVisible(true);
            }
        });
    }
