 ...
 * @author ponki
 */
public class MaterialInventoryView extends javax.swing.JFrame {
    ...
    private void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection.prepareStatement("SELECT * FROM MaterialInventory;");
    ...
    private void clientsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientsbtnActionPerformed
        // TODO add your handling code here:
        MaterialInventoryView adminView = new MaterialInventoryView();
        adminView.show();
        dispose();
    ...
    private void AppointmentsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AppointmentsbtnActionPerformed
        // TODO add your handling code here:
        MaterialInventoryView appointmentsView = new MaterialInventoryView();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialInventoryView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MaterialInventoryView().setVisible(true);
            }
        });
    }
