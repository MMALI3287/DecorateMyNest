 ...
 * @author ponki
 */
public class MaterialInventoryEdit extends javax.swing.JFrame {

    /**
     * Creates new form ClientEdit
     */
    public MaterialInventoryEdit() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialInventoryEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MaterialInventoryEdit().setVisible(true);
            }
        });
    }
