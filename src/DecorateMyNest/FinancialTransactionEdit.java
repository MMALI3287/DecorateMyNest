 ...
 * @author ponki
 */
public class FinancialTransactionEdit extends javax.swing.JFrame {

    /**
     * Creates new form ClientEdit
     */
    public FinancialTransactionEdit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        clientsbtn.setBorder(javax.swing.BorderFactory.createEtchedBorder());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinancialTransactionEdit.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinancialTransactionEdit().setVisible(true);
            }
        });
    }
