 ...
 * @author ponki
 */
public class ProjectArchiveView extends javax.swing.JFrame {
    ...
    private void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection.prepareStatement("SELECT * FROM ProjectArchive;");
    ...
    private void clientsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientsbtnActionPerformed
        // TODO add your handling code here:
        ProjectArchiveView adminView = new ProjectArchiveView();
        adminView.show();
        dispose();
    ...
    private void AppointmentsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AppointmentsbtnActionPerformed
        // TODO add your handling code here:
        ProjectArchiveView appointmentsView = new ProjectArchiveView();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProjectArchiveView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProjectArchiveView().setVisible(true);
            }
        });
    }
