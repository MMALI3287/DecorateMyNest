 ...
 * @author ponki
 */
public class EmployeeRosterEdit extends javax.swing.JFrame {

    /**
     * Creates new form ClientEdit
     */
    public EmployeeRosterEdit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        addresslabel1.setText("Position ID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeRosterEdit.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeRosterEdit().setVisible(true);
            }
        });
    }
