 ...
 * @author ponki
 */
public class ProjectArchiveEdit extends javax.swing.JFrame {

    /**
     * Creates new form ClientEdit
     */
    public ProjectArchiveEdit() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProjectArchiveEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProjectArchiveEdit().setVisible(true);
            }
        });
    }
